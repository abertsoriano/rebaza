...
@section('title', '- Abogados Consejeros Externos')
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="row">
					...
					<div class="col-sm-9">
						<article class="news-block">
							<h6 class="text-normal text-bold">{{ trans('abogadoConsejerosExternos.title') }}</h6>
							<h4 class="text-normal text-bold">
								<a class="abogados" href="{{ route('abogadosocios') }}">{{ trans('abogadoConsejerosExternos.title_1') }}</a>
								<a class="abogados" href="{{ route('abogadoasociados') }}">{{ trans('abogadoConsejerosExternos.title_2') }}</a>
                                {{ trans('abogadoConsejerosExternos.title_3') }}
							</h4>
						</article>
					</div>
