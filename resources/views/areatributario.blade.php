			...
			<div class="col-sm-12">
				<div class="row">
					...
					<div class="col-sm-9 col-xs-12">
						<article class="news-block">
							<h6 class="text-normal text-bold">Tributario</h6>
							<p>El área tributaria de Rebaza, Alcázar & De Las Casas provee un servicio personalizado a empresas nacionales y extranjeras, respecto a los temas tributarios que son aplicables a sus negocios. Asesoramos a una amplia gama de clientes y sectores; banca, construcción, energía, concesiones privadas y públicas, servicios financieros, entidades gubernamentales, retail, seguros, telecomunicaciones, transporte, entre otros.</p>
